...
$contentTrans = 'J4LANDING_ARTICLE_' . (int) $item->id . '_CONTENT';

$title = $lang->hasKey($titleTrans) ? Text::_($titleTrans) : $item->title;
$content = $lang->hasKey($contentTrans) ? Text::_($contentTrans) : $item->introtext;
?>
...
<?php if ($params->get('img_intro_full') !== 'none' && !empty($item->imageSrc)) : ?>
	<figure class="newsflash-image">
		<?php
			...
			echo HTMLHelper::_('image', $img->url, $item->imageAlt, $extraAttr);
		?>
