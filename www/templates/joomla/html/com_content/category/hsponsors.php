	...
	<?php if (!empty($this->intro_items)) : ?>
		<?php foreach ($this->intro_items as $key => &$item) : ?>
			...
			<div class="span<?php echo round(12 / $this->columns); ?>">
				<div class="item column-<?php echo $rowcount; ?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?><?php echo ($item->featured) ? ' well featured' : ''; ?>" itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting">
              <?php echo ($item->featured) ? '<span class="label label-success"><i class="icon-star icon-white"></i> Featured Hosting Partner</span>' : ''; ?>
					<?php
					$this->item = &$item;
					echo $this->loadTemplate('item');
					?>
...
<?php endif; ?>
 ...
 <?php if ($this->maxLevel != 0 && !empty($this->children[$this->category->id])) : ?>
		<div class="cat-children hsponsors">
